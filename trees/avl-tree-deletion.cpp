...
Node* deleteNode(Node* root, int data)
{
    ...
    int left_child_balance = balanceFactor(root->left);
    int right_child_balance = balanceFactor(root->right);
        
    
    if(balance == 2 && left_child_balance >= 0)
    ...
    else if(balance == -2 && right_child_balance <= 0)
